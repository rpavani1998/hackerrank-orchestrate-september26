...
This is a component-first audit after commit `7c1d996`. It is intentionally
 diagnostic: it does not change production logic, regenerate predictions, or
modify `output.csv` or `evaluation/sample_baseline.txt`.
